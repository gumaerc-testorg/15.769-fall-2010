...
This class is for anyone interested in operations and strategy, with a focus on second-year {{% resource_link "cc8c3ebb-e16a-4716-9622-5fd12fd78121" "Leaders for Global Operations" %}} and management students, particularly those aspiring to careers in (1) operations, (2) general management, (3) entrepreneurship, or (4) management consulting. A working knowledge of operations, which, for many firms, employs the greatest number of employees and requires the largest investment in assets, is often indispensable for general managers and entrepreneurs.
